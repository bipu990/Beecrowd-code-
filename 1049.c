...
int main() {
    ...
    if (strcmp(word1, "vertebrado") == 0) {
        if (strcmp(word2, "ave") == 0) {
            ...
            if (strcmp(word3, "onivoro") == 0) printf("pomba\n");
        }
        if (strcmp(word2, "mamifero") == 0) {
            if (strcmp(word3, "onivoro") == 0) printf("homem\n");
            if (strcmp(word3, "herbivoro") == 0) printf("vaca\n");
        }
    }

    if (strcmp(word1, "invertebrado") == 0) {
        if (strcmp(word2, "inseto") == 0) {
            if (strcmp(word3, "hematofago") == 0) printf("pulga\n");
            if (strcmp(word3, "herbivoro") == 0) printf("lagarta\n");
        }
        if (strcmp(word2, "anelideo") == 0) {
            if (strcmp(word3, "hematofago") == 0) printf("sanguessuga\n");
            if (strcmp(word3, "onivoro") == 0) printf("minhoca\n");
        }
    }
